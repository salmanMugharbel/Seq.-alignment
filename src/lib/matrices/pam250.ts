 ...
 * Reference: Dayhoff MO (1978). "A model of evolutionary change in proteins."
 * Atlas of Protein Sequence and Structure 5(3):345-352.
 *
 * PAM250 is appropriate for comparing distantly related sequences (~20% identity).
 */

export const PAM250_RESIDUES = [
...
//  A   R   N   D   C   Q   E   G   H   I   L   K   M   F   P   S   T   W   Y   V
  ...
  [-2,  6,  0, -1, -4,  1,  3, -3,  2, -2, -3,  3,  0, -4,  0,  0, -1,  2, -4, -2],
  ...
  [ 0,  3,  1,  3, -5,  2,  4,  0,  1, -2, -3,  0, -2, -5, -1,  0,  0, -7, -4, -2],
...
export const PAM250: Record<string, Record<string, number>> = {};

for (let i = 0; i < PAM250_RESIDUES.length; i++) {
  PAM250[PAM250_RESIDUES[i]] = {};
  for (let j = 0; j < PAM250_RESIDUES.length; j++) {
    PAM250[PAM250_RESIDUES[i]][PAM250_RESIDUES[j]] = RAW[i][j];
  }
}

 ...
 * For closely related sequences. More sensitive for short, similar alignments.
 */

export const PAM30_RESIDUES = [
...
//  A   R   N   D   C   Q   E   G   H   I   L   K   M   F   P   S   T   W   Y   V
  ...
  [-7,  8, -6,-10, -8, -2, -9, -9, -2, -5, -8, -2, -4, -9, -4, -3, -6, -2,-10, -8],
  ...
  [-7, -2, -1, -4,-14, -3, -4, -7, -6, -6, -8,  7, -2,-14, -6, -4, -3,-12,-9, -9],
  ...
  [-8,-10, -4,-11, -4,-12, -8,-14, -3, -6, -7, -9,-11,  2,-13, -7, -6, -5, 9,-7],
  [-2, -8, -8, -8, -6, -7, -6, -5, -6,  2, -2, -9, -1, -8, -6, -6, -3,-15, -7,  7],
];

export const PAM30: Record<string, Record<string, number>> = {};

for (let i = 0; i < PAM30_RESIDUES.length; i++) {
  PAM30[PAM30_RESIDUES[i]] = {};
  for (let j = 0; j < PAM30_RESIDUES.length; j++) {
    PAM30[PAM30_RESIDUES[i]][PAM30_RESIDUES[j]] = RAW[i][j];
  }
}
